...
const area = pi * Math.pow(2, radius)
...
const mysel = {
    ...
    isHungry: true,
    favouriteAnimal: 'Dog',
    favouriteFoods: ['Ferges', 'Byrek', 'Tav Kosi'],
    address: {
        city: 'Durres',
        country: 'Albania',
        street: 'A.Goga'
...
const foods = mysel.favouriteFoods
const personName = mysel.name

function eat(personName, foods) {
    for (const food of foods) {
        console.log(`${personName} ate ${food}`)
    }
}
